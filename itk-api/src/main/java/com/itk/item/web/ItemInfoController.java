...
public class ItemInfoController {
    ...
    @RequestMapping(value = "/selectByCategoryIdAndStatus", method = RequestMethod.DELETE)
    ...
    @RequestMapping(value = "/selectByShopIdAndStatus", method = RequestMethod.DELETE)
    ...
    @RequestMapping(value = "/selectByShopCategoryIdAndStatus", method = RequestMethod.DELETE)
